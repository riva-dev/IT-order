		...
		generateSimpleCart = function (space) {
		    ...
		    var selectorEngines = {
				...
				currencies = {
				    ...
				    "AUD": { code: "AUD", symbol: "US&#36; ", name: "Australian Dollar" },
				    "BRL": { code: "BRL", symbol: "US&#36; ", name: "Brazilian Real" },
				    "CAD": { code: "CAD", symbol: "US&#36; ", name: "Canadian Dollar" },
				    "CZK": { code: "CZK", symbol: "&nbsp;&#75;&#269;", name: "Czech Koruna", after: true },
				    "DKK": { code: "DKK", symbol: "DKK&nbsp;", name: "Danish Krone" },
				    "EUR": { code: "EUR", symbol: "&euro; ", name: "Euro", decimal: ",", after: true },
				    "HKD": { code: "HKD", symbol: "&#36;", name: "Hong Kong Dollar" },
				    "HUF": { code: "HUF", symbol: "&#70;&#116;", name: "Hungarian Forint" },
				    "ILS": { code: "ILS", symbol: "&#8362;", name: "Israeli New Sheqel", after: true },
				    "JPY": { code: "JPY", symbol: "&yen;", name: "Japanese Yen", accuracy: 0 },
				    "MXN": { code: "MXN", symbol: "US&#36; ", name: "Mexican Peso" },
				    ...
				    //"FRF": { code: "FRF", symbol: "&euro; ", name: "euro" , decimal: "," , after: true },
				    "ARS": { code: "ARS", symbol: "US&#36; ", name: "US Dollar" }
				},
				...
				// default options
				settings = {
				    checkout: { type: "PayPal", email: "telaway@telaway.com" },
				    currency: "USD",
				    conversionRate: 1,
				    language: "english-us",
		    ...
		    simpleCart.extend({
		        ...
		        add: function (values, opt_quiet) {
		            //values["itemtype"] = values["itemtype"]==null ? "": "AC";
		            var info = values || {},
		        ...
		        grandTotal: function () {
		            return simpleCart.total() + simpleCart.tax() + simpleCart.shipping() - simpleCart.promoCode();
		        },

		        grandTotalWithDollar: function () {
		            return (simpleCart.grandTotal()) * settings.conversionRate;
		        },

		        grandTotalPromoCode: function () {
		            simpleCart.update();
		        },
		        ...
		        // return all items in the list as arrey
		        allItems: function () {
		            return JSON.parse(localStorage.simpleCart_items);
		        },
		    ...
		    /*******************************************************************
			 *	TAX AND SHIPPING AND PROMOCODE
			 *******************************************************************/
		    simpleCart.extend({
		    ...
		    cartColumnViews = {
		        ...
		        image: function (item, column) {
		            return "<img src='" + item.get(column.attr) + "' class='small-img'/>";
		        },
		    ...
		    simpleCart.ready(function () {
		        simpleCart.bindOutlets({
					...
					, grandTotalWithDollar: function () {
					    return simpleCart.toCurrency(simpleCart.grandTotalWithDollar(), { symbol: '$', decimal: ".", after: false });
