    ...
    function closebar() {
        ...
        document.getElementById("popupDiv4").style.visibility = "hidden"
    }

    function staticbar() {
        if (document.getElementById("popupDiv4") == null)
            return;
        barheight = document.getElementById("popupDiv4").offsetHeight
